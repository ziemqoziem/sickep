...
$iconAturanCuti = 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z';
$iconAjukanCuti = 'M12 4v16m8-8H4';
...
$navSections = [
    ...
    [
        'group' => 'Cuti Baru',
        'items' => [
            ['route' => 'cuti-baru.ajukan', 'label' => 'Ajukan Cuti', 'icon' => $iconAjukanCuti],
            ['route' => 'cuti-baru.riwayat', 'label' => 'Riwayat Cuti Saya', 'icon' => $iconRiwayatCuti],
            ['route' => 'cuti-baru.persetujuan', 'label' => 'Persetujuan Saya', 'icon' => $iconPersetujuan],
            ['route' => 'cuti-baru.persetujuan-akhir', 'label' => 'Persetujuan Akhir Besar/CLTN', 'icon' => $iconPersetujuanAkhir, 'admin' => true],
        ],
    ],
    [
